...
#define FILE_NODE "../data/road.cnode"
#define FILE_EDGE "../data/road.cedge"
...
#define FILE_NODES_GTREE_PATH "../data/road.paths"
#define FILE_GTREE 			  "../data/road.gtree"
#define FILE_ONTREE_MIND	  "../data/road.minds"
// input
#define FILE_OBJECT "../data/cab.object"
